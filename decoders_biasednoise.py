...
def PTEQ(init_code, p, eta=0.5, Nc=None, SEQ=2, TOPS=10, tops_burn=2, eps=0.1, steps=50000000, iters=10, conv_criteria='error_based'):
    ...
    ladder = Ladder(p, init_code, eta, Nc, 0.5)
...
if __name__ == '__main__':
    ...
    for p in p_rates:
        ...
        for m in range(des):
            ...
            distrs = PTEQ(copy.deepcopy(init_code), p=p_error, eta=eta)
