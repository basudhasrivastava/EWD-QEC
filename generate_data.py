...
if __name__ == '__main__':
    ...
    # Build file path
    file_path = os.path.join(local_dir, 'data_size_'+str(params['size'])+'_method_'+params['method']+'_id_' + array_id + '_perror_' + str(params['p_error']) + '_steps_' + str(params['steps']) +  '_2000err.xz')
